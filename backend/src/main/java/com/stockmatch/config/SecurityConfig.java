...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 인증 없이 가능한 API
                        .requestMatchers("/api/auth/**", "/oauth2/**", "/login/**" , "/api/stocks/**", "/api/corporate/**", "/api/market/**", "/api/exchange-rate/**", "/api/stocks/search")
                        .permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173", "http://140.245.67.224", "http://stockmatch.kro.kr", "https://stockmatch.kro.kr")); // Vite React 기본 포트
