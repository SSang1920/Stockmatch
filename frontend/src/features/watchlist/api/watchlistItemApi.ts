...
export const addWatchlistItem = async (watchlistId: number, ticker: string, memo?: string): Promise<number> => {
    ...
    const response = await axios.post<ApiResponse<number>>(`/api/watchlists/${watchlistId}/items`, body);
...
export const updateWatchlistItem = async (watchlistId: number, itemId: number, memo: string): Promise<void> => {
    ...
    const response = await axios.patch<ApiResponse<void>>(`/api/watchlists/${watchlistId}/items/${itemId}`, body);
...
export const deleteWatchlistItem = async (watchlistId: number, itemId: number): Promise<void> => {
    const response = await axios.delete<ApiResponse<void>>(`/api/watchlists/${watchlistId}/items/${itemId}`);
...
export const sortWatchlistItems = async (watchlistId: number, itemIds: number[]): Promise<void> => {
    ...
    const response = await axios.patch<ApiResponse<void>>(`/api/watchlists/${watchlistId}/items/sort`, body);
